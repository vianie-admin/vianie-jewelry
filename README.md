...
**URL en producción**: [Aquí irá tu URL de Netlify después del deploy](#)

---

## 🚀 Despliegue en Netlify (100% AUTOMÁTICO)

### ✅ NO necesitas cambiar NADA manual

Las URLs de SEO se detectan automáticamente. Solo sigue estos pasos:

### Opción 1: Drag & Drop (Más fácil - 30 segundos) ⭐
...
### Opción 2: Conectando a Git (Recomendado para actualizaciones)
...
El sitio **detecta automáticamente** el dominio donde se despliega y actualiza:
- ✅ Meta tags Open Graph (Facebook, WhatsApp, LinkedIn)
- ✅ Twitter Cards
- ✅ Canonical URLs
- ✅ Imágenes OG

**No necesitas cambiar nada** - funciona en:
